...
type UplodaMetaRequest struct {
	...
	FileLastModified *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=file_last_modified,json=fileLastModified,proto3,oneof" json:"file_last_modified,omitempty"`
}
...
var file_meta_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x4d, 0x0a, 0x12, 0x66,
